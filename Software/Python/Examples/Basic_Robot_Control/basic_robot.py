...
import gopigo as gpg 	#Has the basic functions for controlling the GoPiGo Robot
...
while True:
	...
	a=input()	# Fetch the input from the terminal
	if a=='w':
		gpg.fwd()	# Move forward
	elif a=='a':
		gpg.left()	# Turn left
	elif a=='d':
		...
		gpg.increase_speed()	# Increase speed
	elif a=='g':
		gpg.decrease_speed()	# Decrease speed
	elif a=='z':
		print("Exiting")		# Exit
		sys.exit()
	else:
